  ...
  return (
    <section className="relative overflow-hidden bg-earth-grad pt-32 pb-20 text-cream lg:pt-44 lg:pb-28">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, oklch(0.86 0.17 82 / 0.25), transparent 60%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center lg:px-12">
        ...
        >
          Whether you formulate, retail, or build wellness brands — let's craft a powder that
          carries your name and our roots.
        </motion.p>
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <Link to="/contact">
            <MagneticButton variant="gold">Contact Us</MagneticButton>
          </Link>

          <Link to="/bulk-order">
            <MagneticButton
              variant="ghost"
              className="!text-cream !border-cream/30 hover:!bg-cream hover:!text-forest-deep"
            >
              Bulk Inquiry
            </MagneticButton>
          </Link>
