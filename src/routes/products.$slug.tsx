    ...
    <>
      <section className="relative overflow-hidden pt-40 pb-24">
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at top, ${p.scentColor}, transparent 60%), var(--cream)`,
          }}
        />
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 lg:grid-cols-12 lg:px-12">
          <div className="lg:col-span-7">
            <Link
              to="/products"
              className="text-[11px] uppercase tracking-[0.35em] text-forest/70 hover:text-turmeric"
            >
              ← All products
            </Link>
            {/* export badges */}
            <div className="mt-4 flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full border border-forest/20 px-3 py-0.5 text-[9px] uppercase tracking-[0.3em] text-forest/60">
                Export Grade
              </span>
              <span className="rounded-full border border-forest/20 px-3 py-0.5 text-[9px] uppercase tracking-[0.3em] text-forest/60">
                Private Label Ready
            ...
            <p className="mt-5 max-w-lg text-base text-forest-deep/80 leading-relaxed">
              {p.tagline}
            </p>
            <p className="mt-2 text-xs uppercase tracking-[0.3em] text-forest/60">
              Origin · {p.origin}
            </p>
          ...
          <div className="relative flex justify-center lg:col-span-5">
            ...
            <motion.div
              ...
              style={{
                background: `radial-gradient(circle at 50% 50%, ${p.scentColor}80, transparent 70%)`,
              }}
            />
            {p.image ? (
              <motion.div
                ...
                style={{
                  ...
                  maskImage:
                    "linear-gradient(to bottom, transparent 0%, black 18%, black 80%, transparent 100%), linear-gradient(to right, transparent 0%, black 12%, black 88%, transparent 100%)",
              ...
              <div
                className="relative w-full aspect-[4/3] flex items-center justify-center rounded-3xl overflow-hidden"
                style={{
              ...
              >
                ...
                />
                <span
                  className="relative z-10 text-[8vmin] drop-shadow-lg"
                  role="img"
                  aria-label={p.name}
                >
                  {p.emoji}
          ...
          <div className="rounded-3xl bg-forest-grad p-8 text-cream lg:p-12">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {p.nutrition.map((n: string) => (
                <span
                  key={n}
                  className="rounded-full border border-cream/20 bg-cream/5 px-4 py-2 text-sm"
                >
                  {n}
                </span>
              ))}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="rounded-3xl glass p-10 lg:p-14">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              <div>
                <div className="text-[10px] uppercase tracking-[0.45em] text-turmeric">
                  Export Enquiry
                </div>
                ...
                <p className="mt-4 text-forest-deep/70 leading-relaxed">
                  We supply in bulk and private-label formats with flexible MOQ. Reach out for
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="mb-8 flex items-end justify-between gap-4">
            <h2 className="text-display text-3xl text-forest-deep lg:text-5xl">
              More from the field
            </h2>
            <Link
              to="/products"
              className="text-xs uppercase tracking-[0.3em] text-forest hover:text-turmeric"
            >
              View all →
            </Link>
          </div>
              ...
              >
                {o.image ? (
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at 40% 40%, ${o.scentColor}40, transparent 70%)`,
                    }}
                  >
                    <img
                      src={imgUrl(o.image)}
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: `radial-gradient(circle at 30% 30%, ${o.scentColor}, transparent 70%)`,
                      }}
                    />
                  </div>
                )}
                <div className="p-5">
                  ...
                  <div className="mt-1 text-xs uppercase tracking-[0.3em] text-forest/60">
                    {o.category}
                  </div>
                </div>
              </Link>
